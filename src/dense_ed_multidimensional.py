"""
dense_ed_multidimensional.py: This script defines the class used to build our CNN surrogate model.
...
class DenseED(nn.Module):  #From "Convolutional Dense Encoder-Decoder Networks"
    def __init__(self, in_channels, out_channels, blocks, growth_rate=16,
                 num_init_features=128, bn_size=4, drop_rate=0, outsize_even=True,
                 bottleneck=False):
        """
        Args:
...
class DenseED_phase2(nn.Module):
    def __init__(self,model_p0,model_p1):
        ...
        self.features.add_module('up2', model_p1.features.up2)
