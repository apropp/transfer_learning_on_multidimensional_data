"""
utils_surrogate.py: This script defines helper functions for our CNN surrogate.
...
def loader_train(data, num_training, Nxy, bs, scale, order=0):
    '''
    ...
    print('loader_train input dimensions:')
    print(X_train.shape)
    print(y_train.shape)
...
def model_train(train_loader, test_loader, reps, n_epochs, log_interval, model_orig, lr, wd, factor, min_lr):
    ...
    for rep in range(reps):
        ...
        for epoch in range(1, n_epochs+1):
            ...
            print('Epoch {}. Test RMSE = {}'.format(epoch, rmse_t))

        print('Done training {} epochs. Test RMSE = {}'.format(n_epochs, rmse_t))
